...
@SpringBootTest
@ActiveProfiles("test")
class AuctionDaoTest(@Autowired val dao: AuctionItemDao) {
    ...
    fun `Auction item current price is starting price plus bids`(){
        dao.getItem("b030b21b-73f9-40ff-8518-4a45f2c9b769").apply {
            shouldNotBeNull()
    ...
    fun `Auction item current price is starting price when there are no bids`(){
       dao.getItem("76bce495-219d-4632-a0bb-3e2977b7ae83").apply {
            shouldNotBeNull()
